...
const addPurchases = (arr) => {
  return arr.reduce((firstItem, currentPrice) => {
    return firstItem = firstItem + currentPrice.purchasePrice;
  },0);
};
...
const returnNames = (arr) => {
   return arr.reduce((fullName, character) => {
    fullName.push(character.name);
    return fullName;
 },[]);
};
